/// @description draw_sprite_player(sprite,subimage,x,y,xscale,yscale,rot,color,alpha,inverted)
/// @param sprite
/// @param subimage
/// @param x
/// @param y
...
/// @param alpha
/// @param inverted
function draw_sprite_player(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
