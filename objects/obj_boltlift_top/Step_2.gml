...
&& (obj_playerparent.state < 2)) {
    ...
    if (x < x-xprevious) && (!collision_rectangle(obj_playerparent.bbox_left,obj_playerparent.bbox_top+4,obj_playerparent.bbox_left,obj_playerparent.bbox_bottom-1,obj_solid,0,0))
    || (x > x-xprevious) && (!collision_rectangle(obj_playerparent.bbox_right,obj_playerparent.bbox_top+4,obj_playerparent.bbox_right,obj_playerparent.bbox_bottom-1,obj_solid,0,0))
