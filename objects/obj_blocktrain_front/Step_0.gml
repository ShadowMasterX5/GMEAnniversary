...
//Push Mario
if ((hspeed < 0) && (collision_rectangle(bbox_left-2-hspeed,bbox_top+1,bbox_left-2,bbox_bottom,obj_playerparent,0,0)))
|| ((hspeed > 0) && (collision_rectangle(bbox_right+2,bbox_top+1,bbox_right+2+hspeed,bbox_bottom,obj_playerparent,0,0)))
