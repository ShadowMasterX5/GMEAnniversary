...
if (mybrick == noone) {
    ...
    if ((xscale == -1) && (collision_rectangle(bbox_left-3,bbox_top,bbox_left,bbox_bottom-1,obj_bluebrick, 0, 0)))
    || ((xscale == 1) && (collision_rectangle(bbox_right,bbox_top,bbox_right+3,bbox_bottom-1,obj_bluebrick, 0, 0))) {
