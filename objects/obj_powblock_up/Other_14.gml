...
|| (collision_rectangle(x-1,bbox_bottom+1,x+1,bbox_bottom+1,obj_slopeparent,1,0)) {
    ...
    if (vspeed > 0) {
        ...
        instance_create(__view_get( e__VW.XView, 0 )+__view_get( e__VW.WView, 0 )/2,__view_get( e__VW.YView, 0 ),obj_powkiller);
        
        //Create a new mushroom block
        with (instance_create(x,y,obj_smoke)) sprite_index = spr_powblock_th;
