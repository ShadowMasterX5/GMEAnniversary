...
|| (collision_rectangle(x-1,bbox_bottom+1,x+1,bbox_bottom+1,obj_slopeparent,1,0)) {
    ...
    if (vspeed > 0) {
        ...
        //Create an item depending of the sprite shown
        switch (image_index) {
        
            //Mushroom
            case (0): {
            
                with (sprite_make_object(x+8,y-14,spr_mushroom)) 
                    permission = 1;
            } break;
            ...
            case (1): {
                ...
                //Create a bomb
                with (instance_create(x+8,y-14,obj_turnip_bomb)) {
            ...
            //Sorcerer
            case (2): instance_create(x+8,y-6,obj_sorcerer) break;
        }
