...
if (sprite_index == spr_trampoline_p) {
    ...
    //Set the end sprite
    sprite_index = spr_trampoline_p_end;
}
else if (sprite_index == spr_trampoline_p_end) {
